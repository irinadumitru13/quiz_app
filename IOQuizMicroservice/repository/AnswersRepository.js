...
const getByQuestionIdAsync = async (question_id) => {
    ...
    return await queryAsync('SELECT * FROM ANSWERS WHERE question_id = $1', [question_id]);
};
...
const updateAllByIdAsync = async (id, question_id, answer, is_correct, points) => {
    ...
    const answers =  await queryAsync('UPDATE ANSWERS SET question_id = $1, answer = $2, is_correct = $3, points = $4  WHERE id = $5 RETURNING *',
...
const updateQuestionIdByIdAsync = async (id, question_id) => {
    ...
    const answers =  await queryAsync('UPDATE ANSWERS SET question_id = $1 WHERE id = $2 RETURNING *',
        [question_id, id]);
...
const updateAnswerByIdAsync = async (id, answer) => {
    ...
    const answers =  await queryAsync('UPDATE ANSWERS SET answer = $1 WHERE id = $2 RETURNING *',
        [answer, id]);
...
const updateIsCorrectByIdAsync = async (id, is_correct) => {
    ...
    const answers =  await queryAsync('UPDATE ANSWERS SET is_correct = $1 WHERE id = $2 RETURNING *',
        [is_correct, id]);
...
const updatePointsByIdAsync = async (id, points) => {
    ...
    const answers =  await queryAsync('UPDATE ANSWERS SET points = $1 WHERE id = $2 RETURNING *',
        [points, id]);
...
const updateQuestionIdAnswerByIdAsync = async (id, question_id, answer) => {
    ...
    const answers =  await queryAsync('UPDATE ANSWERS SET question_id = $1, answer = $2 WHERE id = $3 RETURNING *',
...
const updateQuestionIdIsCorrectByIdAsync = async (id, question_id, is_correct) => {
    ...
    const answers =  await queryAsync('UPDATE ANSWERS SET question_id = $1, is_correct = $2 WHERE id = $3 RETURNING *',
...
const updateQuestionIdPointsByIdAsync = async (id, question_id, points) => {
    ...
    const answers =  await queryAsync('UPDATE ANSWERS SET question_id = $1, points = $2 WHERE id = $3 RETURNING *',
...
const updateAnswerIsCorrectByIdAsync = async (id, answer, is_correct) => {
    ...
    const answers =  await queryAsync('UPDATE ANSWERS SET answer = $1, is_correct = $2 WHERE id = $3 RETURNING *',
...
const updateAnswerPointsByIdAsync = async (id, answer, points) => {
    ...
    const answers =  await queryAsync('UPDATE ANSWERS SET answer = $1, points = $2 WHERE id = $3 RETURNING *',
        [answer, points, id]);
...
const updateIsCorrectPointsByIdAsync = async (id, is_correct, points) => {
    ...
    const answers =  await queryAsync('UPDATE ANSWERS SET is_correct = $1, points = $2 WHERE id = $3 RETURNING *',
...
const updateQuestionIdAnswerIsCorrectByIdAsync = async (id, question_id, answer, is_correct) => {
    ...
    const answers =  await queryAsync('UPDATE ANSWERS SET question_id = $1, answer = $2, is_correct = $3 WHERE id = $4 RETURNING *',
...
const updateQuestionIdAnswerPointsByIdAsync = async (id, question_id, answer, points) => {
    ...
    const answers =  await queryAsync('UPDATE ANSWERS SET question_id = $1, answer = $2, points = $3 WHERE id = $4 RETURNING *',
...
const updateQuestionIdIsCorrectPointsByIdAsync = async (id, question_id, is_correct, points) => {
    ...
    const answers =  await queryAsync('UPDATE ANSWERS SET question_id = $1, is_correct = $2, points = $3 WHERE id = $4 RETURNING *',
...
const updateAnswerIsCorrectPointsByIdAsync = async (id, answer, is_correct, points) => {
    ...
    const answers =  await queryAsync('UPDATE ANSWERS SET answer = $1, is_correct = $2, points = $3 WHERE id = $4 RETURNING *',
...
const deleteByIdAsync = async (id) => {
    ...
    const quiz = await queryAsync('DELETE FROM ANSWERS WHERE id = $1 RETURNING *', [id]);
